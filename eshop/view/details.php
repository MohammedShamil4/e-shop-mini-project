...
?>
            ...
            </div><div><h1><I><FONT color=Green><b>Welcome to <?php echo $row['shop_name'] ?> shop</b></font></I></h1></div><p>
<?php
}  
?>
...
<?php
	  ...
	  $sql="select*from offers natural join shop where shop_id=$shop_id";
...
<div class="image">
 <img src="'.$row['product_img'].'" height="180" width="180"  class="img-responsive"> 
</div>
<div class="title">
<h3><b>
'.$row['product_name'].'</b></h3>
